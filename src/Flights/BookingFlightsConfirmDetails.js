    ...
    const fare = async () => {
      ...
      fetch(URL, {
        ...
        .then((data) => {
          ...
          var mainAirportTo =
            segments[segmentLength - 1].Destination.Airport.AirportName;
          var j;
          var segArray = [];
          ...
          var totalTax =
            dat.Fare.Tax +
            dat.Fare.OtherCharges +
            dat.Fare.ServiceFee +
            dat.Fare.AdditionalTxnFeePub;
          ...
          flightDataArray.push({
            ...
            infantCount,
            infantCount,
            mainCityFrom: mainCityFrom,
            mainCityTo: mainCityTo,
          });
                  ...
                  <div class="col-lg-8">
                    <div class="bg-light shadow-md rounded p-3 p-sm-4 confirm-details">
                                ...
                                <div class="row align-items-center trip-title">
                                  ...
                                  <div class="col col-md-auto text-center ml-auto order-sm-0">
                                    <span
                                      className={
                                        flight.refundable
                                          ? "badge badge-success py-1 px-2 font-weight-normal text-1"
                                          : "badge badge-danger py-1 px-2 font-weight-normal text-1"
                                      }
                                    >
                                      {flight.refundable
                                        ? "Refundable"
                                ...
                                <div class="row">
                                  <div class="col-12 col-sm-3 text-center text-md-left d-lg-flex company-info">
                                    ...
                                    <span class="align-middle ml-lg-2">
                                      {" "}
                                      <span class="d-block text-2 text-dark mt-1 mt-lg-0">
                                        {segment.AirlineName}
                                      </span>{" "}
                                      ...
                                      <div class="modal-body">
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <ul>
                                              <li>
                                                The penalty is subject to 4 hrs
                                                before departure. No Changes are
                                                allowed after that.
                                              </li>
                                              <li>
                                              ...
                                              <li>
                                                ...
                                                allowed on tickets booked under
                                                special discounted fares.
                                              </li>
                                              <li>
                                                In case of no-show or ticket not
                                                cancelled within the stipulated
                                                time, only statutory taxes are
                                                refundable subject to Service
                                                Fee.
                                              </li>
                                              <li>
                      ...
                      <div class="alert alert-info mt-4">
                        {" "}
                        <span class="badge badge-info">NOTE:</span> This is a
                        special fare given by the airline. Airlines cancellation
                        charges do apply.{" "}
                      </div>
                      <h2 class="text-6 mb-3 mt-5">
                        Traveller Details -{" "}
                        <span class="text-3">
                          <a
                            data-toggle="modal"
                      ...
                      {parseInt(localStorage.getItem("adultCount")) == 0 ? (
                        ...
                        adultList.map((x, i) => (
                          <>
                            ...
                            <div class="form-row">
                              <div class="col-sm-2 form-group">
                                <select
                                  ...
                                  name="title"
                                  value={x.title}
                                  onChange={(e) => handleAdultChange(e, i)}
                                  required
                                >
                            ...
                            {parseInt(localStorage.getItem("adultCount")) !=
                            i + 1 ? (
                      ...
                      {parseInt(localStorage.getItem("childrenCount")) == 0 ? (
                        ...
                        childrenList.map((x, i) => (
                          <>
                            ...
                            {parseInt(localStorage.getItem("childrenCount")) !=
                            i + 1 ? (
                      ...
                      {parseInt(localStorage.getItem("infantCount")) == 0 ? (
                        ...
                        infantList.map((x, i) => (
                          <>
                            ...
                            {parseInt(localStorage.getItem("infantCount")) !=
                            i + 1 ? (
                    ...
                    <div class="bg-light shadow-md rounded p-3 p-sm-4 confirm-details mt-30">
                      ...
                      <p class="mb-5">
                        Get all the benefits for just ₹ 199 per traveller (18%
                        GST included) <a href="#">Know more</a>
                      </p>

                      {flightDetails?.map((flight) => (
                        <p class="p-subhead">
                          Valid for: {flight.mainCityFrom}- {flight.mainCityTo}
                        </p>
                      ))}
                        ...
                        <div class="col-sm-4 padd-10">
                          <div class="border-01 padd-05 br-4">
                            <div class="d-left">
                              {" "}
                              <span class="align-middle">
                                <img src="images/brands/flights/indigo.png" />{" "}
                              </span>{" "}
                            </div>
                            <div class="d-right">
                              {" "}
                      ...
                      <div class="form-row mt-10">
                        <div class="col-sm-12 form-group">
                          ...
                          />
                          <label for="yes">Yes, secure my trip,</label>
                          <br />
                          <span class="rad-text">
                            I agree to the Terms & Conditions , and confirm that
                            all passengers are above 2 years of age
                          </span>
                          <br />
                          <input
                            type="radio"
                    ...
                    <aside class="col-lg-4 mt-4 mt-lg-0">
                      <div class="bg-light shadow-md rounded p-3">
                        ...
                        <ul class="list-unstyled">
                          <li class="mb-2">
                            Base Fare{" "}
                            <span class="float-right text-4 font-weight-500 text-dark">
                              ₹{flight.totalBaseFare}
                            </span>
                            <br />
                            <small class="text-muted">
                              Adult : {flight.adultCount}, Child :{" "}
                              {flight.childrenCount}, Infant :{" "}
                              {flight.infantCount}
                            </small>
                          </li>
                          <li class="mb-2">
                        ...
                        <div class="text-dark bg-light-4 text-4 font-weight-600 p-3">
                          {" "}
                          Total Amount{" "}
                          <span class="float-right text-6">
                            ₹
                            {insurance == "yes"
                              ? flight.publishedFare + 199
                        ...
                        <ul class="promo-code pre-scrollable">
                          <li>
                            <span class="d-block text-3 font-weight-600">
                              FLTOFFER
                            </span>
                            Up to $500 Off on your booking. Hurry! Limited
                            period offer.{" "}
                            <a class="text-1" href="#">
                              Terms & Conditions
                            </a>
