...
function TwoWayFlightSearchDetails() {
  ...
  const fetchMoreData = () => {
    ...
    setTimeout(() => {
      setCurrentFlights(
        currentFlights.concat(
          flightData.slice(indexOfFirstFlight, indexOfLastFlight)
        )
      );
    }, 1500);
  ...
  const fetchMoreData1 = () => {
    ...
    setTimeout(() => {
      setCurrentFlights1(
        currentFlights1.concat(
          flightData1.slice(indexOfFirstFlight, indexOfLastFlight)
        )
      );
    }, 1500);
  ...
  useEffect(() => {
    const search = async () => {
          ...
          Segments: [
            {
              ...
              PreferredDepartureTime:
                localStorage.getItem("departDate") + "T00: 00: 00",
            ...
            },
            {
              ...
              FlightCabinClass: localStorage.getItem("flightClass"),
              PreferredDepartureTime:
                localStorage.getItem("returnDate") + "T00: 00: 00",
              PreferredArrivalTime:
                localStorage.getItem("returnDate") + "T00: 00: 00",
            },
          ],
      ...
      await fetch(
        "https://api.travelvogues.com/api/SearchFlights",
        requestOptions
      )
        ...
        .then((data) => {
          ...
          for (i = 0; i < dataLength; i++) {
            ...
            var totalTax =
              dat[i].Fare.Tax +
              dat[i].Fare.OtherCharges +
              dat[i].Fare.ServiceFee +
              dat[i].Fare.AdditionalTxnFeePub;
            ...
            var cityMainTo =
              segments[segmentLength - 1].Destination.Airport.CityName;
            var mainDepTime = segments[0].Origin.DepTime.substring(11, 16);
            var mainArrTime = segments[
              segmentLength - 1
            ...
            for (j = 0; j < segmentLength; j++) {
              ...
              var destinationAirportName =
                segments[j].Destination.Airport.AirportName;
            ...
            flightDataArray.push({
              ...
              cityMainFrom: cityMainFrom,
              cityMainTo: cityMainTo,
              mainDepTime: mainDepTime,
              mainArrTime: mainArrTime,
              segArray: segArray,
          ...
          var indexOfFirstFlight = indexOfLastFlight - 6;
          var current = flightDataArray.slice(
            indexOfFirstFlight,
            indexOfLastFlight
          );
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-4">
                <ul class="breadcrumb justify-content-start justify-content-md-end mb-0">
                  ...
                  <li>
                    <a href="booking-flights.html">Flights</a>
                  </li>
                      ...
                      <div class="travellers-dropdown">
                        ...
                        <div class="row align-items-center">
                          <div class="col-sm-7">
                            <p class="mb-sm-0">
                              Children{" "}
                              <small class="text-muted">(2-12 yrs)</small>
                            </p>
                          </div>
                          <div class="col-sm-5">
                            <div class="qty input-group">
                        ...
                        <div class="row align-items-center">
                          <div class="col-sm-7">
                            <p class="mb-sm-0">
                              Infants{" "}
                              <small class="text-muted">(Below 2 yrs)</small>
                            </p>
                          </div>
                          <div class="col-sm-5">
                            <div class="qty input-group">
              ...
              <div class="row">
                <aside class="col-md-3">
                  <div class="bg-light shadow-md rounded p-3">
                    ...
                    <div
                      class="accordion accordion-alternate style-2"
                      id="toggleAlternate"
                    >
                      <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <div class="custom-control custom-checkbox">
                              <input
                                ...
                                class="custom-control-input"
                              />
                              <label class="custom-control-label" for="1stop">
                                1 Stop
                              </label>
                            </div>
                            <div class="custom-control custom-checkbox">
                              <input
                                ...
                                class="custom-control-input"
                              />
                              <label class="custom-control-label" for="2stop">
                                2+ Stop
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="custom-control custom-checkbox clearfix">
                              <input
                                ...
                                class="custom-control-input"
                              />
                              <label class="custom-control-label" for="midDay">
                                Mid-Day
                              </label>
                              <small class="text-muted float-right">
                                12pm - 4pm
                          ...
                          <div class="card-body">
                            ...
                            <div class="custom-control custom-checkbox">
                              <input
                                ...
                                class="custom-control-input"
                              />
                              <label class="custom-control-label" for="indiGo">
                                IndiGo
                              </label>
                            </div>
                            <div class="custom-control custom-checkbox">
                  ...
                  <div class="bg-light shadow-md rounded py-4">
                    <div class="row no-gutters">
                      <div class="col-6">
                        <div class="px-3">
                          <h2 class="text-5">
                            {flightData[0].cityMainFrom} <small>to</small>{" "}
                            {flightData[0].cityMainTo}
                          </h2>
                        </div>
                        <div class="text-1 bg-light-3 border border-left-0 py-2 px-3">
                          <div class="form-row">
                            <div class="col col-sm col-lg-3 text-center d-none d-sm-block">
                              Airline
                            </div>
                            <div class="col-6 col-sm col-lg-3 text-center">
                              Departure
                            </div>
                            <div class="col-6 col-sm col-lg-3 text-center">
                              Arrival
                            </div>
                            <div class="col col-sm col-lg-3 text-right d-none d-sm-block">
                              Price
                            </div>
                          </div>
                        </div>
                              ...
                              {currentFlights.map((flight, index) => (
                                <div class="flight-item">
                                  <div class="form-row align-items-center flex-row pt-4 pb-2 px-3">
                                    <div class="col-12 col-sm col-lg-3 d-flex align-items-center text-center mb-2 mb-sm-0 company-info">
                                      ...
                                      <div class="d-block">
                                        ...
                                        <img
                                          class="img-fluid"
                                          alt=""
                                          src="images/brands/flights/indigo.png"
                                        />{" "}
                                        <span class="d-block text-1 text-dark">
                                          {flight.segArray[0].AirlineName}
                                        </span>{" "}
                                      </div>
                                    </div>
                                    <div class="col-6 col-sm col-lg-3 text-center time-info">
                                      {" "}
                                      <span>{flight.mainDepTime}</span>{" "}
                                    ...
                                    <div class="col-6 col-sm col-lg-3 text-center time-info">
                                      {" "}
                                      <span>{flight.mainArrTime}</span>{" "}
                                      <small class="text-muted d-none d-sm-block">
                                        18h 55m
                                      </small>{" "}
                                    </div>
                                    <div class="col-12 col-sm col-lg-3 text-center text-sm-right text-dark text-4 price">
                                      ₹{flight.publishedFare}
                                    </div>
                                    <div class="col col-sm-auto col-lg-3 ml-auto text-0 text-center text-sm-right">
                                      <a
                                        style={{
                                          cursor: "pointer",
                                          color: "#0E7FD9",
                                          ...
                                          <div class="flight-details">
                                            <div class="row mb-4">
                                              ...
                                              <div class="col-12 col-sm-3 col-lg-2 text-center text-sm-right mt-3 mt-sm-0">
                                                {" "}
                                                <span class="text-dark text-7 price">
                                                  ₹{flight.publishedFare}{" "}
                                                </span>{" "}
                                                <span class="text-1 text-muted d-block">
                                                  (Per Adult)
                                                </span>{" "}
                                                <span class="text-1 text-danger d-block">
                                                  2 seat(s) left
                                                </span>
                                              </div>
                                            </div>
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                <ul>
                                                  <li>
                                                    The penalty is subject to 4
                                                    hrs before departure. No
                                                    Changes are allowed after
                                                    that.
                                                  </li>
                                                  <li>
                                                    The charges are per
                                                  ...
                                                  <li>
                                                    ...
                                                    allowed on tickets booked
                                                    under special discounted
                                                    fares.
                                                  </li>
                                                  <li>
                                                    In case of no-show or ticket
                                                    not cancelled within the
                                                  ...
                                                  <li>
                                                    No Baggage Allowance for
                                                    Infants
                                                  </li>
                                                  <li>
                                                    Airline penalty needs to be
                                                    reconfirmed prior to any
                      ...
                      <div class="col-6">
                        <div class="px-3">
                          <h2 class="text-5">
                            {flightData1[0].cityMainFrom} <small>to</small>{" "}
                            {flightData1[0].cityMainTo}
                          </h2>
                        </div>
                                  ...
                                  <div class="form-row align-items-center flex-row pt-4 pb-2 px-3">
                                    <div class="col-12 col-sm col-lg-3 d-flex align-items-center text-center mb-2 mb-sm-0 company-info">
                                      <div class="custom-control custom-radio custom-control-inline mr-1">
                                        <input
                                          ...
                                          checked={
                                            Resultindex1 == flight.resultIndex
                                          }
                                          type="radio"
                                        />
                                      </div>
                                      <div class="d-block">
                                        ...
                                        <img
                                          class="img-fluid"
                                          alt=""
                                          src="images/brands/flights/jetairways.png"
                                        />{" "}
                                        <span class="d-block text-1 text-dark">
                                          {flight.segArray[0].AirlineName}
                                        </span>{" "}
                                    ...
                                    <div class="col col-sm-auto col-lg-3 ml-auto text-0 text-center text-sm-right">
                                      <a
                                        ...
                                        onClick={(e) => clickHandler1(e, index)}
                                      >
                                        Flight Details
                                      </a>
                                    </div>
                                          ...
                                          <div class="flight-details">
                                            <div class="row mb-4">
                                              ...
                                              <div class="col-12 col-sm-3 col-lg-2 text-center text-sm-right mt-3 mt-sm-0">
                                                ...
                                                <span class="text-1 text-danger d-block"></span>
                                              </div>
                                            </div>
                                            <ul
                                              class="nav nav-tabs"
                                            ...
                                            >
                                              ...
                                              <li class="nav-item">
                                                ...
                                                <a
                                                  class="nav-link"
                                                  id="returnsecond-tab2"
                                                  data-toggle="tab"
                                                  href="#returnsecond2"
                                                  role="tab"
                                                  aria-controls="second2"
                                                  aria-selected="false"
                                                >
                                                  Fare Details
                                                </a>{" "}
                                              ...
                                              <li class="nav-item">
                                                ...
                                                <a
                                                  class="nav-link"
                                                  id="returnfourth-tab2"
                                                  data-toggle="tab"
                                                  href="#returnfourth2"
                                                  role="tab"
                                                  aria-controls="fourth2"
                                                  aria-selected="false"
                                                >
                                                  Cancellation Fee
                                                </a>{" "}
                                            ...
                                            <div
                                              class="tab-content my-3"
                                              id="returnmyTabContent2"
                                            >
                                              <div
                                                class="tab-pane fade show active"
                                                id="returnfirst2"
                                                role="tabpanel"
                                                aria-labelledby="returnfirst-tab2"
                                              >
                                                {flight.segArray.map(
                                                  (segment) => (
                                                    <div class="row flex-row pt-4 px-md-4">
                                                      ...
                                                      <div class="col-12 col-sm-3 text-center time-info mt-3 mt-sm-0">
                                                        {" "}
                                                        <span class="text-3 text-dark"></span>{" "}
                                                        {segment.hour}h{" "}
                                                        {segment.min}m{" "}
                                                        <small class="text-muted d-block">
                                                          Duration
                                              ...
                                              <div
                                                ...
                                                id="returnsecond2"
                                                role="tabpanel"
                                                aria-labelledby="returnsecond-tab2"
                                              >
                                                <div class="table-responsive-md">
                                                  <table class="table table-hover table-bordered bg-light">
                                                    <tbody>
                                              ...
                                              <div
                                                ...
                                                id="returnthird2"
                                                role="tabpanel"
                                                aria-labelledby="returnthird-tab2"
                                              >
                                                <div class="table-responsive-md">
                                                  <table class="table table-hover table-bordered bg-light">
                                                    <thead>
                                              ...
                                              <div
                                                ...
                                                id="returnfourth2"
                                                role="tabpanel"
                                                aria-labelledby="returnfourth-tab2"
                                              >
                                                <table class="table table-hover table-bordered bg-light">
                                                  <thead>
                                                    <tr>
                ...
                <div class="round-trip-fare fixed-bottom bg-dark shadow-md text-light">
                  <div class="container p-2 p-sm-4">
                    <div class="row align-items-center">
                          ...
                          {firstFlight?.map((flight) => (
                            <div class="col-12 col-sm-6 border-right border-dark">
                              <div class="row align-items-center flex-row">
                                <div class="col col-sm-4 col-md-3 text-center d-lg-flex company-info">
                                  {" "}
                                  <span class="align-middle d-none d-sm-block">
                                    <img
                                      class="img-fluid"
                                      alt=""
                                      src="images/brands/flights/indigo.png"
                                ...
                                <div class="col col-sm-4 col-md-3 text-center time-info">
                                  {" "}
                                  <span class="text-4">
                                    {flight.mainDepTime}
                                  </span>{" "}
                                ...
                                <div class="col-md-3 text-center d-none d-md-block time-info">
                                  {" "}
                                  <span class="text-1">
                                    {flight.totalHours == 0
                                      ? ""
                                ...
                                <div class="col col-sm-4 col-md-3 text-center d-lg-flex company-info">
                                  ...
                                  <span class="align-middle d-none d-sm-block">
                                    <img
                                      class="img-fluid"
                                      alt=""
                                      src="images/brands/flights/spicejet.png"
                                    />{" "}
                                  </span>{" "}
                                  <span class="align-middle ml-lg-2">
                                    {" "}
                      ...
                      <div class="col-3">
                        <div class="row align-items-center">
                          <div class="col-12 col-md-6 text-light text-center text-6 price">
                            <span class="text-1 text-white-50 d-none d-lg-block">
                              Total Fare:{" "}
                            </span>
                            ₹{totalFare + markup}
                          </div>
                          <div class="col-12 col-md-6 text-center mt-2 mt-md-0 btn-book">
                            ...
                            <a
                              ...
                              class="btn btn-sm btn-primary px-sm-2 px-lg-3"
                            >
